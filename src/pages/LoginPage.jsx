        ...
        >
          <div className="space-y-8">
            ...
            >
              ...
              <div>
                <p className="text-2xl font-bold text-slate-900 dark:text-white">7000+</p>
                <p className="text-sm text-slate-600 dark:text-slate-400">Lines of Code</p>
              </div>
            </motion.div>
            ...
            >
              <p className="text-xs font-semibold text-slate-600 dark:text-slate-400 uppercase tracking-wider">Platform Highlights</p>
              
              <motion.div
                whileHover={{ x: 4 }}
                className="flex items-start gap-3 p-3 rounded-lg bg-slate-100/50 dark:bg-slate-800/30 hover:bg-slate-100 dark:hover:bg-slate-800/50 transition-all group"
              >
                ...
                <div>
                  <p className="text-sm font-semibold text-slate-900 dark:text-white">Zero TypeScript Errors</p>
                  <p className="text-xs text-slate-600 dark:text-slate-500">Production-grade code quality</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  <p className="text-sm font-semibold text-slate-900 dark:text-white">60fps Animations</p>
                  <p className="text-xs text-slate-600 dark:text-slate-500">Smooth Framer Motion transitions</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  <p className="text-sm font-semibold text-slate-900 dark:text-white">100% Responsive</p>
                  <p className="text-xs text-slate-600 dark:text-slate-500">Mobile, tablet, and desktop</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  <p className="text-sm font-semibold text-slate-900 dark:text-white">AI Chat Assistant</p>
                  <p className="text-xs text-slate-600 dark:text-slate-500">Natural language project queries</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  <p className="text-sm font-semibold text-slate-900 dark:text-white">Dark/Light Mode</p>
                  <p className="text-xs text-slate-600 dark:text-slate-500">Eye-comfortable design system</p>
                </div>
              </motion.div>
            </motion.div>
            ...
            >
              <p className="text-xs font-semibold text-slate-600 dark:text-slate-400 uppercase tracking-wider mb-3">Tech Stack</p>
              <div className="flex flex-wrap gap-2">
                {['React 18+', 'Vite', 'Tailwind CSS', 'Framer Motion', 'Mongoose', 'Express'].map((tech) => (
                  <motion.span
                    key={tech}
                    whileHover={{ scale: 1.05 }}
                    className="px-3 py-1.5 bg-slate-100 dark:bg-slate-800 text-xs font-medium text-slate-700 dark:text-slate-300 rounded-full border border-slate-200 dark:border-slate-700"
                  >
                    {tech}
                  </motion.span>
                ))}
