        ...
        >
          ...
          <div className="space-y-5">
            {[
              ...
              >
                <div className="h-10 w-10 rounded-lg bg-gradient-to-br from-primary/20 to-blue-500/20 text-primary flex items-center justify-center font-black text-lg flex-shrink-0 group-hover:scale-110 transition-transform">
